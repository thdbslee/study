 ...
 <script src="https://code.jquery.com/ui/1.12.1/jquery-ui.js"></script>
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            ...
            <button class="btn btn-link btn-sm order-1 order-lg-0" id="sebarToggle" href="#"><i class="fas fa-bars"></i></button>
            <!-- Navbar Search-->
                    					...
                    					<tbody>
                    							...
                    							<c:forEach var="list" items="${list}">
                    								...
                    								<!--  <td><input type="checkbox" id="chk" name="chk">
                    									<input type="hidden" id="INX" name="INX" value="${li }</td>
                    								<td style="cursor:pointer;color:#blue;" onclick="javascript:fn_click('${list.INX}')">
                    								${list.TITLE}</td>
                    								<td style="cursor:pointer;color:#blue;" >${list.NAME}</td>
                    								<td style="cursor:pointer;color:#blue;" >${list.INFO}</td>
                    								<td style="cursor:pointer;color:#blue;" >${list.INSERT_DATE}</td>
                    								</tr>-->
                    							</c:forEach>
